...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 77 08 00 	movl   $0x877,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 430:	0f b6 80 dc 0a 00 00 	movzbl 0xadc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 58d:	75 09                	jne    598 <printf+0x101>
          s = "(null)";
 58f:	c7 45 f4 90 08 00 00 	movl   $0x890,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 659:	a1 f8 0a 00 00       	mov    0xaf8,%eax
...
free(void *ap)
{
 ...
 724:	a3 f8 0a 00 00       	mov    %eax,0xaf8
}
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 777:	e8 ce fe ff ff       	call   64a <free>
  return freep;
 77c:	a1 f8 0a 00 00       	mov    0xaf8,%eax
}
 781:	c9                   	leave  
 782:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 795:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 798:	a1 f8 0a 00 00       	mov    0xaf8,%eax
 79d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a4:	75 23                	jne    7c9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 45 f0 f0 0a 00 00 	movl   $0xaf0,-0x10(%ebp)
 7ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b0:	a3 f8 0a 00 00       	mov    %eax,0xaf8
 7b5:	a1 f8 0a 00 00       	mov    0xaf8,%eax
 7ba:	a3 f0 0a 00 00       	mov    %eax,0xaf0
    base.s.size = 0;
 7bf:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 7c6:	00 00 00 
  }
 ...
 81c:	a3 f8 0a 00 00       	mov    %eax,0xaf8
      return (void*)(p + 1);
 ...
 827:	eb 38                	jmp    861 <malloc+0xde>
    ...
    if(p == freep)
 829:	a1 f8 0a 00 00       	mov    0xaf8,%eax
